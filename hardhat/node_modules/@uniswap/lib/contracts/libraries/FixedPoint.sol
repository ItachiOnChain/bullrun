...
library FixedPoint {
    // Define max values for each type to avoid explicit casting issues
    uint224 private constant MAX_UINT224 = 2**224 - 1; // Maximum value for uint224
    uint144 private constant MAX_UINT144 = 2**144 - 1; // Maximum value for uint144
    uint112 private constant MAX_UINT112 = 2**112 - 1; // Maximum value for uint112
